...
func TestResolve(t *testing.T) {
	tests := []struct {
		...
		{
			name:               "claude-sonnet-4 with thinking suffix falls back to default",
		...
		{
			name:               "unknown claude model falls back to default",
		...
		{
			name:               "unknown claude model with thinking suffix falls back to default",
